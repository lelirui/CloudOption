...
cd /root/com_pkgs_original_new_arch/com_base_standalone/;sh interface_install.sh > /root/install.test 2>&1
cd /root/com_pkgs_original_new_arch/com_base_standalone/;sh job_install.sh  >> /root/install.test 2>&1
